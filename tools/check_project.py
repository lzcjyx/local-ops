...
def check_required_files() -> str:
    required = (
        ...
        "server.py",
        "adcc/__init__.py",
        "adcc/agents/__init__.py",
        "adcc/agents/models.py",
        "adcc/agents/runner.py",
        "adcc/cli/__init__.py",
        "adcc/cli/main.py",
        ...
        "adcc/core/events.py",
        "adcc/core/models.py",
        "adcc/git/__init__.py",
        "adcc/git/repository.py",
        "adcc/mcp/__init__.py",
        "adcc/mcp/server.py",
        "adcc/orchestrator/__init__.py",
        "adcc/orchestrator/executor.py",
        "adcc/orchestrator/locks.py",
        "adcc/orchestrator/models.py",
        "adcc/platform/__init__.py",
        "adcc/platform/base.py",
        "adcc/platform/macos.py",
        "adcc/platform/windows.py",
        "adcc/platform/unsupported.py",
        "adcc/projects/__init__.py",
        "adcc/projects/detection.py",
        "adcc/projects/models.py",
        "adcc/projects/registry.py",
        "adcc/runtime/__init__.py",
        "adcc/runtime/lifecycle.py",
        "adcc/runtime/ports.py",
        "adcc/runtime/processes.py",
        "adcc/runtime/runs.py",
        "adcc/runtime/tasks.py",
        "adcc/storage/__init__.py",
        "adcc/storage/config.py",
        "adcc/storage/database.py",
        "start.command",
